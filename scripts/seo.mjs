...
const ROUTES = [
    ...
    },
    {
        ...
        priority: '0.9',
        changefreq: 'monthly',
        title: `Репертуар: песни Магомаева, эстрада, арии и романсы — ${NAME}`,
        description:
            'Полный репертуар баритона Рудольфа Овсепяна: 26 песен из репертуара Муслима Магомаева, 59 эстрадных хитов от Ободзинского до Лепса, 9 оперных арий и 30 романсов. Любую песню можно добавить к программе вашего вечера.',
    },
    {
        path: 'about',
        priority: '0.8',
        changefreq: 'monthly',
        title: `Биография, образование и награды — ${NAME}, баритон`,
        description:
            'Рудольф Ваграмович Овсепян: МГПИ им. Ипполитова-Иванова (класс Р.П. Лисициана), Тверской музыкальный колледж, премия С.Я. Лемешева, лауреат международных конкурсов, гастроли фонда Владимира Спивакова во Франции и Бельгии.',
    },
    {
        path: 'gallery',
        priority: '0.7',
